...
import com.hazoc.cursomc.domain.PagamentoComCartao;
...
import com.hazoc.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void InstantiateDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "hazoc.dev.test@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
		...
		ItemPedido ip2 = new ItemPedido(ped1, p3, 0.00, 8, 80.00);
